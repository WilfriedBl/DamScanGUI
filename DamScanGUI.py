"""GUI-front-end for DamScan & DamCompare version 1.5.0 by Juha Lintula """
__version__ = "0.1.6"

import tkinter.ttk as ttk
# GUI module generated by PAGE version 4.9
# In conjunction with Tcl version 8.6
#    Oct 26, 2017 08:57:23 AM
import sys
...
class Analyze_Daminion_Catalog:
    def __init__(self, top=None):
        ...
        self.lbl_Daminion_Environment.configure(relief=GROOVE, foreground="black", text='''Daminion Environment''')
        self.lbl_Daminion_Environment.configure(background="#d9d9d9", highlightbackground="#d9d9d9", highlightcolor="black")
        self.lbl_Daminion_Environment.configure(takefocus="0", width=730)
        ...
        self.Label_Catalog_Path_Name.configure(activebackground="#f9f9f9", activeforeground="black", anchor=W)
        self.Label_Catalog_Path_Name.configure(background="#d9d9d9", disabledforeground="#a3a3a3", foreground="#000000")
        self.Label_Catalog_Path_Name.configure(highlightbackground="#d9d9d9", highlightcolor="black", justify=LEFT)
        self.Label_Catalog_Path_Name.configure(takefocus="0", text='''Select or Enter Catalog Name:''')

        self.txt_dbpath = Entry(self.lbl_Daminion_Environment)
        self.txt_dbpath.configure(background="#d9d9d9", disabledforeground="#a3a3a3", font=font12, foreground="#000000")
        self.txt_dbpath.configure(highlightbackground="#d9d9d9", highlightcolor="black", insertbackground="black")
        self.txt_dbpath.configure(relief=FLAT, selectbackground="#c4c4c4", selectforeground="black")
        ...
        self.txt_dbname = Entry(self.lbl_Daminion_Environment,background="#d9d9d9",disabledforeground="#a3a3a3")
        self.txt_dbname.configure(font=font14,foreground="#000000",highlightbackground="#d9d9d9",highlightcolor="black")
        self.txt_dbname.configure(insertbackground="black",justify=RIGHT,selectbackground="#c4c4c4",selectforeground="black")
        self.txt_dbname.configure(relief=FLAT,textvariable=DamScanGUI_support.txt_dbname)
        self.txt_dbname.place(x=440, y=0, relheight=0.14, width=240)                                    # !!!

        self.Postgres_Server_Port_User__Password1 = Label(self.lbl_Daminion_Environment,activebackground="#f9f9f9")
        self.Postgres_Server_Port_User__Password1.configure(activeforeground="black",anchor=W,background="#d9d9d9",disabledforeground="#a3a3a3")
        self.Postgres_Server_Port_User__Password1.configure(foreground="#000000",highlightbackground="#d9d9d9",highlightcolor="black")
        self.Postgres_Server_Port_User__Password1.configure(takefocus="0",text='''Postgres Server:Port''')
        self.Postgres_Server_Port_User__Password1.place(relx=0.01, y=70, height=20, width=120)                  # !!!

        self.txt_server = Entry(self.lbl_Daminion_Environment,background="white",disabledforeground="#a3a3a3")
        self.txt_server.configure(font=font10,foreground="#000000",highlightbackground="#d9d9d9",highlightcolor="black")
        self.txt_server.configure(insertbackground="black",justify=RIGHT,relief=FLAT)
        self.txt_server.configure(selectbackground="#c4c4c4",selectforeground="black")
        ...
        self.txt_port = Entry(self.lbl_Daminion_Environment,background="white",disabledforeground="#a3a3a3")
        self.txt_port.configure(font=font10,foreground="#000000",highlightbackground="#d9d9d9",highlightcolor="black")
        self.txt_port.configure(insertbackground="black",relief=FLAT,selectbackground="#c4c4c4",selectforeground="black")
        ...
        self.Colon_between_server_port = Label(self.lbl_Daminion_Environment,background="#ffffff",font=font11)
        self.Colon_between_server_port.configure(foreground="#000000",takefocus="0",text=''':''')
        self.Colon_between_server_port.place(x=210, y=70, height=16, width=7)   # !!!

        self.Postgres_User__Password = Label(self.lbl_Daminion_Environment,activebackground="#f9f9f9",activeforeground="black")
        self.Postgres_User__Password.configure(anchor=W,background="#d9d9d9",disabledforeground="#a3a3a3",foreground="#000000")
        self.Postgres_User__Password.configure(highlightbackground="#d9d9d9",highlightcolor="black",takefocus="0")
        ...
        self.txt_user = Entry(self.lbl_Daminion_Environment, background="white", disabledforeground="#a3a3a3")
        self.txt_user.configure(font=font10, foreground="#000000", highlightbackground="#d9d9d9", highlightcolor="black")
        self.txt_user.configure(insertbackground="black", relief=FLAT, justify=RIGHT, selectbackground="#c4c4c4")
        self.txt_user.configure(selectforeground="black", textvariable=DamScanGUI_support.txt_user)
        ...
        self.slash_between_server_port.configure(takefocus="0")
        ...
        self.btn_browse_dmc_1.configure(takefocus="0")
        ...
        self.lbl_catalog_dates.configure(takefocus="0")
        ...
        self.btn_use_dbname_as_ini.configure(takefocus="0")
        ...
        self.sltb_netcatalogs.configure(takefocus="0")
        ...
        self.lbl_rbtn_sqlite.configure(takefocus="0")
        ...
        self.lbl_rbtn_postgres.configure(takefocus="0")
        ...
        self.lbl_select_netcatalog_and_doubleclick.configure(takefocus="0")
        ...
        self.ckb_display_only.configure(padx="0")
        ...
        self.btn_Open_Output_File_in_Notepad.configure(takefocus="0")
        ...
        self.lbl_use_outfile_name_as_ack_file.configure(takefocus="0")
        ...
        self.btn_browse_for_output_file.configure(takefocus="0")
        ...
        self.btn_Open_Output_File_in_Excel.configure(takefocus="0")
        self.btn_Open_Output_File_in_Excel.configure(text='''Excel''')
        self.btn_Open_Output_File_in_Excel.configure(underline="8")

        self.lbl_GPS_tolerance = Label(self.lblAnalysis_Environment)
        self.lbl_GPS_tolerance.place(relx=0.01, rely=0.73, height=20, width=208)
        self.lbl_GPS_tolerance.configure(background="#d9d9d9")
        self.lbl_GPS_tolerance.configure(disabledforeground="#a3a3a3")
        self.lbl_GPS_tolerance.configure(foreground="#000000")
        self.lbl_GPS_tolerance.configure(text='''GPS Tolerance in meters   -   Distance:''')

        self.lbl_alt_tolerance = Label(self.lblAnalysis_Environment)
        self.lbl_alt_tolerance.place(relx=0.41, rely=0.73, height=20, width=51)
        self.lbl_alt_tolerance.configure(background="#d9d9d9")
        self.lbl_alt_tolerance.configure(disabledforeground="#a3a3a3")
        self.lbl_alt_tolerance.configure(foreground="#000000")
        self.lbl_alt_tolerance.configure(text='''Altitude:''')

        self.txt_dist_tolerance = Entry(self.lblAnalysis_Environment)
        self.txt_dist_tolerance.place(relx=0.3, rely=0.73, height=20, relwidth=0.07)
        self.txt_dist_tolerance.configure(background="white")
        self.txt_dist_tolerance.configure(disabledforeground="#a3a3a3")
        self.txt_dist_tolerance.configure(font=font10)
        self.txt_dist_tolerance.configure(foreground="#000000")
        self.txt_dist_tolerance.configure(insertbackground="black")
        self.txt_dist_tolerance.configure(textvariable=DamScanGUI_support.txt_dist_tolerance)
        self.txt_dist_tolerance.configure(width=54)

        self.txt_alt_tolerance = Entry(self.lblAnalysis_Environment)
        self.txt_alt_tolerance.place(relx=0.48, rely=0.73, height=20, relwidth=0.07)
        self.txt_alt_tolerance.configure(background="white")
        self.txt_alt_tolerance.configure(disabledforeground="#a3a3a3")
        self.txt_alt_tolerance.configure(font=font10)
        self.txt_alt_tolerance.configure(foreground="#000000")
        self.txt_alt_tolerance.configure(highlightbackground="#d9d9d9")
        self.txt_alt_tolerance.configure(highlightcolor="black")
        self.txt_alt_tolerance.configure(insertbackground="black")
        self.txt_alt_tolerance.configure(selectbackground="#c4c4c4")
        self.txt_alt_tolerance.configure(selectforeground="black")
        self.txt_alt_tolerance.configure(textvariable=DamScanGUI_support.txt_alt_tolerance)
        ...
        self.btn_browse_ini_files.configure(takefocus="0")
        ...
        self.lbl_use_ini_name_as_outfile_name.configure(takefocus="0")
...
if checked here, but mask below is empty)''')
        ...
        self.lbl_Program_to_Analyse_Groups_or_links1.place(relx=0.01, rely=0.83
                , height=20, width=190)
        self.lbl_Program_to_Analyse_Groups_or_links1.configure(activebackground="#f9f9f9")
        self.lbl_Program_to_Analyse_Groups_or_links1.configure(activeforeground="black")
        self.lbl_Program_to_Analyse_Groups_or_links1.configure(anchor=W)
        ...
        self.txt_damscanpgm1.place(relx=0.3, rely=0.83, relheight=0.07, width=470) # !!
        ...
        self.txt_damscanpgm1.configure(takefocus="0")
        ...
        self.btn_browse_for_acknowledged_list.configure(takefocus="0")
        ...
        self.btn_browse_only_tag_value_lists.configure(takefocus="0")
        ...
        self.btn_browse_for_excluded_tag_value_lists.configure(takefocus="0")
        ...
        self.btn_edit_ack_file.configure(takefocus="0")
        ...
        self.edit_only_file.configure(takefocus="0")
        ...
        self.btn_edit_excluded_file.configure(takefocus="0")
        ...
        self.rbtn_groups1.configure(takefocus="0")
        ...
        self.rbtn_links1.configure(takefocus="0")
        ...
        self.txt_damcompgm.place(relx=0.28, rely=0.83, relheight=0.07, relwidth=0.63) # !!
        ...
        self.txt_damcompgm.configure(takefocus="0")
        ...
        self.btn_browse_dmc_2.configure(takefocus="0")
        ...
        self.btn_browse_excl_paths.configure(takefocus="0")
        ...
        self.btn_browse_only_paths.configure(takefocus="0")
        ...
        self.lbl_catalog_dates1.configure(takefocus="0")
        ...
        self.sltb_netcatalogs2.configure(takefocus="0")
        ...
        self.btn_clear_paths = Button(self.tabs_t2)
        self.btn_clear_paths.place(relx=0.77, rely=0.75, height=24, width=157)
        self.btn_clear_paths.configure(activebackground="#d9d9d9")
        self.btn_clear_paths.configure(activeforeground="#000000")
        self.btn_clear_paths.configure(background="#d9d9d9")
        self.btn_clear_paths.configure(command=DamScanGUI_support.clear_paths)
        self.btn_clear_paths.configure(disabledforeground="#a3a3a3")
        self.btn_clear_paths.configure(foreground="#000000")
        self.btn_clear_paths.configure(highlightbackground="#d9d9d9")
        self.btn_clear_paths.configure(highlightcolor="black")
        self.btn_clear_paths.configure(pady="0")
        self.btn_clear_paths.configure(text='''Clear Exclude & Only Paths''')
        ...
        self.rbtn_analysis_type2.configure(takefocus="0")
        ...
        self.rbtn_analysis_type_compare2.configure(takefocus="0")
        ...
        self.rbtn_analysis_type1.configure(takefocus="0")
        ...
        self.rbtn_analysis_type_compare1.configure(takefocus="0")           #!! underline="8"
        ...
        self.Message1.place(relx=0.01, rely=0.16, relheight=0.05, relwidth=0.97)
        ...
        # self.recent_options.add_checkbutton(variable=DamScanGUI_support.Recent1, label="1.", underline=0, textvariable="1")
        ...
        top.bind(    '<Control-W>', DamScanGUI_support.open_ini_file_in_notepad)        # Shift+Ctrl+W
